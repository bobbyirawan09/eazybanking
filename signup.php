...
<div class="row">
	<div class="col-md-2 col-md-offset-3" id="logo">
		<a href="index.php"><img src="assets/ez_logo.png" style="width: 50%; height: 50%;"></a>
	</div>
	<div class="col-md-4">
		<a href="index.php"><label style="position: absolute; font-size: 25px; font-family: monospace; padding: 20px 0; color: #0000cc;">Eazy</label></a>
	</div>
</div>
            ...
            <form role="form">
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
						...
						<hr>
						<div class="row form-group float-label-control">
							<div class="col-md-12 input-group">
								<label for="i5" class="control-label">Username</label>
								<input type="text" id="i5" class="form-control" name="username" placeholder="Username">
							</div>
						</div>
						...
						<div class="row form-group label-floating">
							<div class="col-md-12 input-group">
								...
								<input type="text" class="form-control" name="hp" placeholder="No. HandPhone anda">
							</div>
						</div>
